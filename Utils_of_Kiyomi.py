...
Reply = 'I am fine Adi'
bye_message = 'Bye, Adi! Take Care! Consult me whenever you need. Kiyomi is always there to support you!'
...
def wish():
    ...
    if hour >= 0 and hour < 12:
        speak_and_print('Good morning! Adi!')
    elif hour >= 12 and hour < 18:
        speak_and_print('Good afternoon Adi!')
    else:
        speak_and_print('Good evening Adi!')
...
def bye():
    ...
    if hour >= 20 and hour <= 4:
        speak_and_print('Good night Adi!')
...
def play_song():
    ...
    while limit_songs not in Song: 
        ...
        if 'exit' in song:
            ...
            try:
                SONG = f'C:\\Users\\Dell\\Songs\\{song}.mp3'
                from playsound import playsound as play
                play(SONG)
            except Exception:
